    ...
    return Container(
        ...
        child: Stack(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  setState(() {
                    ...
                    if(staticValues.getPlayerNo() > 4)
                        if (staticValues.fakeWagerCounter() <
                            ((staticValues.getPlayerNo() / 2).round()) ||
                            staticValues.getFakeWager(i) != 0 ||
                            staticValues.getIsClick(i)) {
                          staticValues.setIsClick(i);
                        }
          ...
          Container(
            ...
            level < 3 && staticValues.getPlayerNo() < 5 && (staticValues.wagerCounter() <
                ((staticValues.getPlayerNo() / 2).round()) ||
                staticValues.getWager(i) != 0)
              ? Container(
            ...
            level < 3 && staticValues.getPlayerNo() > 4 && (staticValues.fakeWagerCounter() <
                ((staticValues.getPlayerNo() / 2).round()) ||
                staticValues.getFakeWager(i) != 0)
                ? Container(
              child: staticValues.getIsClick(i) ? wagerAlert() : Text(""),
