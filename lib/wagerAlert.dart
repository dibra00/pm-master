                          ...
                          setState(() {
                            if (enterNumber <= Max) {
                              staticValues.setMoney(
                                  (staticValues.getMoney()) +staticValues.getFakeWager(i)-
                                      enterNumber);
                              ...
                              staticValues.setReturn(
                                  i,
                                  (staticValues.getReturn(i) -staticValues.getFakeReturn(i)+
                                      returns.returnCalculator(
                                          odds.handOddes[i],
                                          enterNumber.toDouble()))
                                      .round());
                              ...
                              staticValues.setWager(i,
                                  staticValues.getWager(i) - staticValues.getFakeWager(i) +
                                      enterNumber.round());

                              staticValues.setFakeWager(i, enterNumber.round());
                              print('fakewager[$i] : '+ staticValues.getFakeWager(i).toString());
                            ...
                            if (enterNumber <= Max) {
                              ...
                              /*print(staticValues.getReturn(i) +
                                returns.returnCalculator(
                                    odds.handOddes[i],
                                    enterNumber.toDouble()));*/
                              staticValues.setReturn(i, (staticValues.getReturn(i)-staticValues.getFakeReturn(i)
                                  + returns.returnCalculator(
                                      odds.handOddes[i],
                                      enterNumber.toDouble()))
                                  .round()
                              ...
                              staticValues.setFakeWager(i, enterNumber.round());
                              print('fakeReturn[$i] : '+ staticValues.getFakeReturn(i).toString());
                              print('Return[$i] : '+ staticValues.getReturn(i).toString());
