                      ...
                      if (level == 0) {
                        if (staticValues.totalWager() != 0) {
                          setState(() {
                            ...
                            level++;
                            for (int i = 0; i < StaticValues.fakeWagers.length; i++) {
                              staticValues.setFakeWager(i, 0);
                            }
                         //   for (int i = 0; i < StaticValues.returnsList.length; i++) {
                       //       staticValues.setReturn(i, StaticValues.returnsList[i] + staticValues.getFakeReturn(i));
                        //    }
                            for (int i = 0; i < StaticValues.fakeReturns.length; i++) {
                              staticValues.setFakeReturn(i, 0);
                            }
